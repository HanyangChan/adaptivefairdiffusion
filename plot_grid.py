...
def create_image_grid(prompt_name, display_name):
    ...
    columns = [
        ...
        {"title": "Fair Diffusion", "path_template": "results_option1/{prompt}_baseline_constant_3.0_seed_{seed}.png"},
        {"title": "Ours Unoptimized", "path_template": "results_reverse/{prompt}_reverse_cosine_7.0_seed_{seed}.png"},
        {"title": "Ours Optimized", "path_template": "results_option1/{prompt}_reverse_cosine_7.0_seed_{seed}.png"}
    ]
